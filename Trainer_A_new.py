...
def main ():
    ...
    player_hat = DQN_Agent(player=0, env=env, train=False)
    Q = player1.DQN
    Q_hat = Q.copy()
    ...
    for epoch in range(start_epoch, epochs):
        ...
        while not env.is_end_state(state_1):
            ...
            # print(state_1.board.reshape(2,7), action_1, reward_1, after_state_1.scored)
            if end_of_game_1:
                res += reward_1
                buffer.push(state_1, action_1, reward_1, after_state_1, True)
                # print(after_state_1.board.reshape(2,7), -1, 0)
                break
            ...
            # print(state_2.board.reshape(2,7), action_2, reward_2, after_state_2.scored)
            if end_of_game_2:
                # print(after_state_2.board.reshape(2,7), -1, -1)
                res += reward_2
